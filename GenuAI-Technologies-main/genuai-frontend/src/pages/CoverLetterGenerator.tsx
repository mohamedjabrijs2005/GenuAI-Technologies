  ...
  return (
    <div className="cover-gen-page h-screen bg-background quantum-gradient flex flex-col overflow-hidden">
      <style>{`
        ...
        .markdown-body p { margin-bottom: 12px; line-height: 1.6; color: #374151; font-size: 14px; font-weight: 500; }
        .markdown-body ul { margin-bottom: 16px; padding-left: 24px; color: #374151; font-size: 14px; }
        .markdown-body li { margin-bottom: 6px; line-height: 1.6; }
        .markdown-body strong { color: #111827; font-weight: 700; }
        .markdown-body em { font-style: italic; color: #4b5563; font-size: 13px; }
        ...
        <div className="w-full md:w-[35%] md:min-w-[400px] md:max-w-[550px] glass border-r border-surface-container flex flex-col overflow-hidden shadow-md z-10">
          <div className="flex-1 overflow-y-auto p-lg md:p-xl space-y-md">
            ...
            <div>
              ...
              <textarea value={applicantInfo} onChange={e=>setApplicantInfo(e.target.value)} placeholder="Your Contact Details (Name, Phone, Email, LinkedIn...)" rows={2} className="w-full p-sm bg-background border border-surface-container rounded-xl text-sm font-medium text-on-surface outline-none resize-y focus:border-indigo-brand focus:ring-1 focus:ring-indigo-brand transition-all" />
            </div>
            ...
            <div>
              ...
              <textarea value={companyInfo} onChange={e=>setCompanyInfo(e.target.value)} placeholder="Company & Hiring Manager Details" rows={2} className="w-full p-sm bg-background border border-surface-container rounded-xl text-sm font-medium text-on-surface outline-none resize-y focus:border-indigo-brand focus:ring-1 focus:ring-indigo-brand transition-all" />
            </div>
            ...
            <div>
              ...
              <textarea value={signOff} onChange={e=>setSignOff(e.target.value)} placeholder="Sincerely,\n[Your Name]" rows={2} className="w-full p-sm bg-background border border-surface-container rounded-xl text-sm font-medium text-on-surface outline-none resize-y focus:border-indigo-brand focus:ring-1 focus:ring-indigo-brand transition-all" />
            </div>
          </div>
