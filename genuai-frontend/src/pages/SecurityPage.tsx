  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 font-body-base py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-5xl mx-auto space-y-8">
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 sm:p-8 shadow-xl grid grid-cols-1 md:grid-cols-12 gap-6 items-center">
          <div className="md:col-span-4 text-center p-6 rounded-2xl bg-slate-800/40 border border-slate-700/60">
            <div className="text-4xl font-black text-emerald-400 mb-1 font-mono">94%</div>
            <div className="text-xs font-bold text-white uppercase tracking-wider">AI Trust Score Index</div>
            <p className="text-[11px] text-slate-400 mt-2">Evidentiary standard for recruiter verification</p>
          </div>

          <div className="md:col-span-8 space-y-3 text-xs text-slate-300 leading-relaxed">
            <h3 className="text-sm font-bold text-white uppercase tracking-wider">Multi-Signal Fusion Methodology</h3>
            <p>
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 sm:p-8 shadow-xl space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {layers.map((l) => (
              <div key={l.num} className="p-4 rounded-2xl bg-slate-800/40 border border-slate-800 space-y-1">
                <div className="flex items-center justify-between">
                  <span className="font-mono text-xs font-bold text-indigo-400">{l.num}</span>
