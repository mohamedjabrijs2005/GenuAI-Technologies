        ...
        <div className="flex flex-col lg:flex-row gap-8 sm:gap-12 lg:gap-16 items-center">
          ...
          <div className="flex-1 space-y-4 sm:space-y-6">
            ...
            <p className="text-sm sm:text-base text-on-surface-variant/90 leading-relaxed">
              Our multi-dimensional AI ecosystem evaluates candidates across target role requirements, providing real-time, explainable insights. This ensures that every hire is based on true merit and demonstrated capability, bridging the gap between exceptional talent and world-class opportunities.
            </p>
